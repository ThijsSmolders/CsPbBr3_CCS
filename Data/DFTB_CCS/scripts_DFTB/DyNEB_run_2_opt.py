...
for NEB_path in NEB_paths_Cs:
    ...
    images = io.read('neb_PSTRESS_0_' + NEB_path + '.traj@-7:')
    ...
    opt = MDMin(neb, trajectory='neb_PSTRESS_0_' + NEB_path + '_pt_2.traj')
    opt.run(fmax=0.02)

    os.system("ase nebplot neb_PSTRESS_0_" + NEB_path + "_pt_2.traj")
    os.system("mv nebplots.pdf nebplots_PSTRESS_0_" + NEB_path + "_pt_2.pdf")
